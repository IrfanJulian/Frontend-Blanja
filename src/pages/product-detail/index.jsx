  ...
  return (
    <div>
        ...
        <div className="container mx-auto py-20">
            { data ? 
            <div className="flex">         
                <div className="wrapper w-1/2 border">
                    <div className="grid grid-cols-2 gap-5">
                        <img src={data.photo} alt="" className='w-[20rem]' />
                    </div>
                </div>
            ...
            <div className="wrapper my-10">
                ...
                <p className='text-xl font-semibold text-[#DB3022] text-start mt-2'>New</p>
                <p className='text-xl font-semibold text-black text-start mt-10'>Description</p>
                <p className='text-lg text-gray-400 text-start mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium 
                veritatis natus dolores amet, quidem modi at voluptate quibusdam minima maiores facere odit, nisi nobis explicabo assumenda quia! Nam quis 
                velit, aspernatur nostrum quo, voluptates ipsum quaerat praesentium quisquam veniam itaque nobis tenetur iste. Blanditiis dolore aliquid esse 
                laboriosam, voluptate fuga reiciendis molestiae praesentium sunt voluptatem expedita sequi accusamus quia mollitia eveniet a atque, unde 
                repudiandae quae neque cum perspiciatis. Facere mollitia beatae reiciendis labore odit. Sed cumque dolorem inventore, pariatur, laborum provident 
                consequuntur doloribus quia accusantium optio beatae illum praesentium officiis iste asperiores tempore vitae. Nesciunt doloribus dolorum illum 
                praesentium quam dolores fuga, dolore molestiae tempora facere? Sunt quas nobis totam beatae delectus soluta dolorem recusandae necessitatibus, 
                eveniet ut in ipsum explicabo corrupti accusantium maiores commodi consequatur sit reiciendis eaque eos? Ratione, dolore hic, eum incidunt id 
                laboriosam eaque velit adipisci sed exercitationem repellat minus modi eius accusamus qui error aspernatur quia ipsam inventore sint fugiat necessitatibus 
                illo dolorum. Quisquam expedita excepturi, vitae neque illum consequatur veniam soluta quidem quasi cumque, id qui molestias impedit magni iste est itaque 
                accusantium adipisci. Alias modi 
                aut perferendis illo cupiditate maxime ratione soluta magni reprehenderit voluptates, consequuntur vitae, et illum explicabo? Vitae, deserunt!</p>
