...
const CardProducts = ({ photo, tittle, price, brand, classNameCard, classNameImage, classNameTittle, nav }) => {
  ...
  return (
    <div onClick={()=>navigate(nav)} className={classNameCard ? classNameCard : 'card w-full px-2 mx-auto md:mx-0 mb-10 md:mb-0 p-2 border-2 rounded-xl shadow-lg cursor-pointer hover:opacity-70'}>
