  ...
  return (
    <div className={className}>
        <div className="container mx-auto px-4">
            <div className="flex relative px-[44px]">
                <p className='text-lg md:text-2xl'>{name}</p>
                <button className='absolute ml-auto top-1 right-6'>
            ...
            <div className="card w-full flex border-2 p-2">
                <div className="w-1/2 border-r-2 flex">
                    {/* <input type="checkbox" onChange={onChange} /> */}
                    <img src={img} alt="img" className='w-[7rem] h-[7rem] md:w-[17rem] md:h-[17rem] mx-auto' />
                </div>
                <div className="w-1/2 px-2 md:py-2">
                    ...
                    <div className="flex h-max w-max mx-auto my-2 md:my-0">
                        <button onClick={onClick1} className='w-max h-max'><img src={min} alt="min" className='h-4 w-4 md:w-6 md:h-6 border border-gray-400 rounded-full' /></button>
                        <p className='text-xs md:text-[19px] my-auto mx-6'>{qty}</p>
                        <button onClick={onClick2} className='w-max h-max'><img src={plus} alt="plus" className='h-4 w-4 md:w-6 md:h-6 border border-gray-400 rounded-full' /></button>
                    ...
                    <button onClick={onClickCheckout} className='flex mt-3 md:mt-10 ml-auto'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 md:w-[2rem] h-[2rem]">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                        </svg>
                        <p className='text-xs text-blue-600 my-auto md:my-0 md:text-xl mr-2 ml-2'>Buy now</p>
                    </button>
                </div>
            </div>
        </div>
