...
const Card = () => {
  return (
    ...
    <button className="absolute right-2 top-2 p-1 rounded-xl bg-white opacity-50 hover:opacity-100">
      ...
      <img src={jacket} alt="product" className="w-[10.5rem] h-[10.5rem] md:w-[15rem] md:h-[15rem]" />
      <div className="wrapperContent my-3">
        <p className="font-medium text-sm my-2 md:text-lg">T-shirt Eastern Wolves</p>
        <div className="flex px-3">
          <div className="w-1/2 block md:flex border-r">
            ...
            <p className="text-center md:text-left text-xs md:text-sm ml-1">180000</p>
          </div>
          <div className="w-1/2 border-l block md:flex">
            ...
            <p className="text-center md:text-left text-xs md:text-sm ml-1">20</p>
          </div>
        </div>
