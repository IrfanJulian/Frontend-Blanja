        ...
        <div>
            <div className="px-10 pt-10 pb-20 mb-10 border-2 border-gray-300 rounded-lg">
                ...
                <div className="flex mt-10 mr-10">
                    ...
                    <button className='text-gray-400 mx-auto text-xl py-4 px-10 rounded-t-xl font-semibold hover:bg-gray-100 active:border-b-2 border-red-600'>Soldout</button>
                    <button className='text-gray-400 mx-auto text-xl py-4 px-10 rounded-t-xl font-semibold hover:bg-gray-100 active:border-b-2 border-red-600'>Archieve</button>
                </div>
                    ...
                    <div className="card border-2 shadow-xl shadow-gray-400 border-gray-400 rounded-xl p-5 flex">
                        ...
                        <div className="core">
                            ...
                            <div className="wrapper mb-2">
                                ...
                                <p className='text-md text-red-600 font-bold text-start'>Unpaid</p>
                            </div>
                            <div className="wrapper mb-2">
                                <p className='text-lg font-semibold text-start mb-3'>Detail customer :</p>
                                <p className='text-md text-grey-600 font-bold text-start'>id : 231dfs564fg59dg</p>
                                <p className='text-md text-grey-600 font-bold text-start'>name : Hanzo</p>
                            </div>
                        </div>
                    </div>
                </div>
